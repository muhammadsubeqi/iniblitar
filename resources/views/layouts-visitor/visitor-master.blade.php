...
<body>
    ...
    <script src="{{ asset('/visitor/lib/counterup/counterup.min.js') }}"></script>
    <script src="{{ asset('/visitor/lib/owlcarousel/owl.carousel.min.js') }}"></script>

    <!-- Contact Javascript File -->
    <script src="{{ asset('/visitor/mail/jqBootstrapValidation.min.js') }}"></script>
    <script src="{{ asset('/visitor/mail/contact.js') }}"></script>
